...
class QLearner(object):
  ...
  def step_env(self):
    ...
    if np.random.random_sample() < self.exploration.value(self.t) or not self.model_initialized:
    ...
    # store results in replay buffer
  ...
  def update_model(self):
    ...
    if (self.t > self.learning_starts and \
        ...
        # YOUR CODE HERE
        obs_t_batch, act_t_batch, rew_t_batch, obs_tp1_batch, done_mask_batch = self.replay_buffer.sample(self.batch_size)
